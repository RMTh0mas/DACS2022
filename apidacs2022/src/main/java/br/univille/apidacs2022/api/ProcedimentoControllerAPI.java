...
public class ProcedimentoControllerAPI {
    ...
    public ResponseEntity<List<Procedimento>> getAll() {
        var listaProcedimento = service.getAll();
        return new ResponseEntity<List<Procedimento>>(listaProcedimento, HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<Procedimento>> getByNome(@PathVariable("descricao") String descricao) {
        var listaProcedimento = service.getByDescricao(descricao);
        return new ResponseEntity<List<Procedimento>>(listaProcedimento, HttpStatus.OK);
    }
